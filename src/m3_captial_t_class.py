...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.intersection_point = intersection_center
        self.width = width
        self.height = height
        self.thickness = letter_thickness

        self.leftmost_point = rg.Point(intersection_center.x - (width / 2), intersection_center.y - (letter_thickness / 2))
        self.rightmost_point = rg.Point(intersection_center.x + (width / 2), intersection_center.y + (letter_thickness / 2))
        self.h_rect = rg.Rectangle(self.leftmost_point, self.rightmost_point)
        self.uppermost_point = rg.Point(intersection_center.x - (letter_thickness / 2), self.leftmost_point.y)
        self.lowermost_point = rg.Point(intersection_center.x + (letter_thickness / 2), self.leftmost_point.y + height)
        self.v_rect = rg.Rectangle(self.uppermost_point, self.lowermost_point)
    ...
    def clone(self):
        ...
        new_t = CapitalT(self.intersection_point, self.height, self.width, self.thickness)
